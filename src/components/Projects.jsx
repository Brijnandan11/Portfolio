...
const PROJECTS = [
  {
    ...
    title: 'Sentinel-Auth',
    url: '',
    desc: 'Production-grade Authentication & Authorization Service',
    tags: ['Javascript', 'Node', 'JWT', 'Swagger'],
  ...
  },
  {
    ...
    title: 'Forge',
    url: '',
    desc: 'A production-ready Go CLI for tracking Git activity, managing repositories, and maintaining daily coding streaks.',
    tags: ['Go', 'Node', 'PostgreSQL', 'NPM'],
  ...
  {
    key: 'seatlock',
    title: 'Seatlock-Engine',
    url: '',
    desc: 'High-concurrency seat reservation engine — PostgreSQL + Redis distributed locking, comparing pessimistic/Redlock/optimistic strategies under load.',
    tags: ['Typescript', 'Redis', 'Nginx', 'Docker', 'Postgres'],
